...
export class PessoasService {
  ...
  addPessoa(nome: string, curso: string ,cargo: string): Observable<any> {
    const pessoa = {nome: nome, curso: curso, cargo: cargo};
    return this.http.post(this.API_URL + '/pessoas', pessoa);
  }

  updatePessoa(id: number, nome: string, curso: string ,cargo: string): Observable<any> {
    const pessoa = {nome: nome, curso: curso, cargo: cargo};
